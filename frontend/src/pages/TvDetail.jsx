...
function TvDetail() {
  ...
  useEffect(() => {
    async function loadShow() {
      ...
      const externalIds = await getTvExternalIds(id)

      const omdbDetails = externalIds?.imdb_id
        ? await getOmdbDetails(externalIds.imdb_id)
        : null

      setShow(details)
      setOmdbShow(omdbDetails)
  ...
  if (!show) {
    return (
      <div className="h-screen flex items-center justify-center font-headline font-bold text-2xl">
        Loading...
      </div>
    )
  }
  ...
  return (
    <div className="pt-0 min-h-screen">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[380px_1fr] gap-16 items-center w-full">
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                <span className="px-4 py-1.5 bg-primary/20 text-primary border border-primary/20 rounded-full text-[10px] font-black tracking-[0.2em] uppercase">
                  FEATURED SERIES
                </span>

                <span className="px-4 py-1.5 bg-white/5 backdrop-blur-xl border border-white/10 text-on-surface rounded-full text-xs font-bold">
                  {show.genres?.[0]?.name || "Drama"}
                </span>
      ...
      <section className="pt-16 pb-10 px-8 max-w-screen-2xl mx-auto">

        <div className="flex flex-col gap-16">

          <div className="flex flex-col gap-3">

            <h2 className="text-xs uppercase tracking-[0.4em] text-primary font-black">
              CRITICAL ANALYSIS
            </h2>

            <p className="text-4xl md:text-5xl font-headline font-black tracking-tight">
              The Verdict
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white/3 backdrop-blur-sm p-10 rounded-2xl flex flex-col gap-8 border border-white/5 hover:bg-white/5 transition-all duration-500 group relative overflow-hidden">
              ...
              <div className="flex justify-between items-start relative">
                ...
                <span className="text-[11px] font-black tracking-[0.3em] text-on-surface/30 uppercase">
                  IMDb SCORE
                </span>
              ...
              <div className="relative">
                ...
                <div className="text-6xl font-headline font-black text-secondary flex items-baseline gap-1">
                  ...
                  {omdbShow?.imdbRating || "N/A"}

                  <span className="text-xl text-on-surface/20 uppercase tracking-widest font-black">
                    /10
                  </span>

                </div>

                <p className="text-on-surface/40 text-xs mt-3 font-bold tracking-wide">
                  Based on{" "}
                  {omdbShow?.imdbVotes
                    ? formatVoteCount(
                        Number(omdbShow.imdbVotes.replace(/,/g, ""))
                      )
                    : "N/A"}{" "}
                  audience reviews
                </p>
            ...
            <div className="bg-white/3 backdrop-blur-sm p-10 rounded-2xl flex flex-col gap-8 border border-white/5 hover:bg-white/5 transition-all duration-500 group relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <p className="text-on-surface/40 text-xs mt-3 font-bold tracking-wide">
                  Certified Fresh by Top Critics
                </p>
      ...
      <section className="py-10 px-8 bg-white/[0.02] border-y border-white/5">
        ...
        <div className="max-w-screen-2xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-20">
            ...
            <div className="flex flex-col gap-3">
              ...
              <h2 className="text-xs uppercase tracking-[0.4em] text-tertiary font-black">
                COMMUNITY VOICE
              </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-surface-container-low p-8 rounded-xl flex flex-col gap-6 border border-outline-variant/10 relative overflow-hidden group">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-tertiary to-on-tertiary-fixed-variant flex items-center justify-center font-black text-on-tertiary text-xs">
                  U/
                </div>
              ...
              <p className="text-xl font-headline font-medium italic">
                "The cinematography in the second act is genuinely some of the best I've seen in the last decade. The use of practical lighting creates this claustrophobic atmosphere that just works."
              </p>
            ...
            <div className="bg-surface-container-low p-8 rounded-xl flex flex-col gap-6 border border-outline-variant/10 relative overflow-hidden group">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-secondary to-on-secondary-fixed-variant flex items-center justify-center font-black text-on-secondary text-xs">
                  U/
                </div>
              ...
              <p className="text-xl font-headline font-medium italic">
                "Can we talk about the ending? I've watched it twice now and I'm still picking up on the subtle clues left in the background of the detective's office. Masterclass in show-don't-tell."
              </p>
      ...
      {/* Technical Specs */}
      <section className="pt-10 pb-16 px-8 max-w-screen-2xl mx-auto">

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 border-t border-white/5 pt-16">

          {/* Creator */}
          <div className="flex flex-col gap-6">

            <h3 className="text-[11px] font-black uppercase tracking-[0.3em] text-on-surface/30">
              THE VISIONARY
            </h3>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <span className="px-4 py-2 bg-white/5 rounded-lg text-[10px] font-black tracking-widest border border-white/5 uppercase">
                Native 4K
              </span>
