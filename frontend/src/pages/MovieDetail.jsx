          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white/3 backdrop-blur-sm p-10 rounded-2xl flex flex-col gap-8 border border-white/5 hover:bg-white/5 transition-all duration-500 group relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <p className="text-on-surface/40 text-xs mt-3 font-bold tracking-wide">Based on {omdbmovie?.imdbVotes ? formatVoteCount(Number(omdbmovie.imdbVotes.replace(/,/g, ""))) : "N/A"} audience reviews</p>
              </div>
            </div>
            ...
            <div className="bg-white/3 backdrop-blur-sm p-10 rounded-2xl flex flex-col gap-8 border border-white/5 hover:bg-white/5 transition-all duration-500 group relative overflow-hidden">
              ...
              <div className="relative">
                <div className="text-6xl font-headline font-black text-primary flex items-baseline gap-1">
                  {(omdbmovie?.Ratings?.find((r) => r.Source === "Rotten Tomatoes")?.Value?.replace("%", "")) || "N/A"}<span className="text-xl text-on-surface/20 uppercase tracking-widest font-black">%</span>
                </div>
